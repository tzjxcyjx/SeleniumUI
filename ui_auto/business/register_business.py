...
class RegisterBusiness(object):
    ...
    def login_email_error(self,email,username,password,code):
        ...
        if self.register_h.get_user_text("email_error","请输入有效的电子邮件地址") == None:
            ...
            return False
    def login_username_error(self,email,username,password,code):
        self.user_base(email, username, password, code)
    ...
    def login_password_error(self, email, username, password, code):
        self.user_base(email, username, password, code)
    ...
    def login_code_error(self, email, username, password, code):
        self.user_base(email, username, password, code)
    ...
    def login_success(self, email, username, password, code):
        self.user_base(email, username, password, code)
